...
import { GridMethods, TableEditMethods, TableMethods, TableValidatorMethods, VxeGlobalThemeName, VxeGrid, VxeGridEventProps, VxeGridInstance, VxeUI } from 'vxe-table'
