<template>
	<div>
		<BasicTable @register="registerTable">
			<template #toolbar>
				<a-button :preIcon="IconEnum.ADD" v-auth="RoleAuth.ADD" @click="handleCreate" type="primary"> 新增 </a-button>
				<a-button :preIcon="IconEnum.DELETE" v-auth="RoleAuth.DEL" @click="handleDelete" type="primary" color="error"> 删除 </a-button>
			</template>
...
/** 功能权限按钮 */
function handleAuthEdit(record) {
