...
import { deleteRoleInfoApi, listRoleInfoApi } from '@/api/desk-mate/roleInfo.api'
import { deskMateRoleInfoAuth } from '@/auth/desk-mate'
...
function handleCopy(record: RoleInfoIM) {
	openRoleInfoModal(true, { record, isCopy: true })
}
