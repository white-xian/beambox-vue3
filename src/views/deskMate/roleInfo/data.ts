...
export const detailSchema: DescItem[] = [
  ...
  },
  {
    label: '头像',
    field: 'roleCardAvatarUrl',
render: (val) => (val ? h(Image, { src: val, style: { maxWidth: '120px', maxHeight: '120px', borderRadius: '8px' } }) : ''),
    span: 8,
  },
  {
    label: '背景',
    field: 'roleCardBackgroundUrl',
    render: (val) => (val ? h(Image, { src: val, style: { maxWidth: '200px', maxHeight: '100px', borderRadius: '8px' } }) : ''),
    span: 8,
  },
  {
    label: '隐藏款头像',
    field: 'hiddenUrl',
    render: (val) => (val ? h(Image, { src: val, style: { maxWidth: '120px', maxHeight: '120px', borderRadius: '8px', background: '#4d15af' } }) : ''),
    span: 8,
  },
    {
    label: '角色圆形头像',
